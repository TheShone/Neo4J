          ...
          <div class="rib-mesto-card1 col-md-4">
            <form onSubmit={addPisca}>
              <div class="form-group row padding">
                <label for="text" class="col-4 col-form-label" >Ime:</label> 
                <div class="col-8">
                   <input
                      value={name}
              ...
              <div class="form-group row padding">
                <label for="text" class="col-4 col-form-label" >Prezime:</label> 
                <div class="col-8">
                   <input
                      value={surName}
              ...
              <div class="form-group row padding">
                <label for="text" class="col-4 col-form-label" >Datum rodjenja:</label> 
                <div class="col-8">
                <input
                  value={birthDate}
              ...
              <div class="form-group row padding">
                <label for="text" class="col-4 col-form-label" >Datum smrti:</label> 
                <div class="col-8">
                <input
                  value={deathDate}
              ...
              <div class="form-group row padding">
                <label for="text2" class="col-4 col-form-label">Nacionalnost:</label> 
                <div class="col-8">
        ...
        <ng-template>
          <ng-container>
            <div class="rib-mesto-card col-md-4">
                ...
                <h1> KURCINA</h1>
                <p>by: Bas velika kurcina</p>
              <button class="btn fill">Detalji</button>
            </div>
          </ng-container>
      </ng-template>
        </div>
